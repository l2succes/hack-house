...
export const Card = (props: MembershipCardProps) => {
  const { type } = props;
  ...
  return (
    <div
      className={cls(
        ...
        "max-w-[404px] w-full pb-[63%] rounded-lg shadow-lg z-10 relative"
      )}
    >
...
export const MembershipCard: React.FC<MembershipCardProps> = (props) => {
  ...
  return (
    <div className="bg-zinc-200	shadow-md max-w-md mx-auto p-2 lg:p-4 mt-[200px] rounded">
      ...
      <ul className="mx-4 mt-6 mb-10 text-base text-neutral-500">
      ...
      <div className="mt-8 mx-4 mb-8 hidden">
